...
import com.example.happybuy.Model.Cart;
import com.example.happybuy.ViewHolder.CartViewHolder;
import com.example.happybuy.Prevalent.Prevalent;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            public CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_cart_items_layout,parent,false);
